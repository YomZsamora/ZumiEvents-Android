...
public class Event {
     ...
     */
    public Event(Name name, Description description, String id, String url, String vanityUrl, Start start, End end, String organizationId, String created, String changed, Object capacity, Object capacityIsCustom, String status, String currency, Boolean listed, Boolean shareable, Boolean onlineEvent, Integer txTimeLimit, Boolean hideStartDate, Boolean hideEndDate, String locale, Boolean isLocked, String privacySetting, Boolean isSeries, Boolean isSeriesParent, Boolean isReservedSeating, Boolean showPickASeat, Boolean showSeatmapThumbnail, Boolean showColorsInSeatmapThumbnail, String source, Boolean isFree, String version, String logoId, String organizerId, String venueId, String categoryId, Object subcategoryId, String formatId, String resourceUri, Logo logo) {
        super();
        this.name = name;
